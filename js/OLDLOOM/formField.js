define(["jquery", "lib/validators" ],function($, ValidatorLib){
...
FormField.prototype.setupRequiredWhenDisabledOtherwise = function(otherField, theAttr){
            ...
            // now we need to disable the form based on the value.
		}
...
Numeric.prototype.setupControls = function() {
    ...
    var incButton = $("<button type='button' class='inc' tabindex='-1'>+</button>");
    var decButton = $("<button type='button' class='dec' tabindex='-1'>-</button>");
...
ADate.prototype.setupControls = function() {
    ...
    require(["lib/jquery-ui"], function(ui){
